...
//						   struFOC_CtrProc.bMC_RunFlg = 0;
		...
		//#endif
				...
				{
						/* 运行状态  */
      if(FRSControl.TurnOnDelayCnt < HEATER_DELAY_ON_TIME) {FRSControl.TurnOnDelayCnt ++;}  //发热丝启动延时
						  StateRun();                           //闭环处理函数
...
//        struFOC_CurrLoop.mVoltUVW_PWM.nPhaseU = 0; //预充电占空比
//        struFOC_CurrLoop.mVoltUVW_PWM.nPhaseV = 0; //预充电占空比
//        struFOC_CurrLoop.mVoltUVW_PWM.nPhaseW = 0; //预充电占空比
...
//            MCPWM_PRT = 0x0000;
            ...
            struFOC_CurrLoop.mVoltUVW_PWM.nPhaseU = PWM_PERIOD/2;
            struFOC_CurrLoop.mVoltUVW_PWM.nPhaseV = PWM_PERIOD/2;    /* 清零MCPWM比较值寄存器 */
            struFOC_CurrLoop.mVoltUVW_PWM.nPhaseW = PWM_PERIOD/2;
...
//            MCPWM_PRT = 0x0000;
        ...
        else if( struTime.nChargeTime >= (CHARGE_TIME * 3))
        {

            struAppCommData.bChargeEndFlag = 2;
        }
    }

    if(struAppCommData.bChargeEndFlag == 2)//预充电完成
    {
        struAppCommData.bChargeFlag = 0;
        struTime.nChargeTime = 0;
        struAppCommData.bChargeEndFlag = 0;
    ...
    if( struTime.nOpenRunCntr < OPEN2CLOSE_RUN_COV_TIME)
    {
        if((g_FluxObsMode == 1)&&(ABS(struMotorSpeed.wSpeedEst) > struAppCommData.wCloseSpeed))
        {
            struTime.nOpenRunCntr ++;
					struTime.nOpenRunCntr=OPEN2CLOSE_RUN_COV_TIME;
        }
        else
        {
            struTime.nOpenRunCntr = 0;
        }
				        struMotorSpeed.mSpeedPI.wIntegral = (s64)struFOC_CurrLoop.mStatCurrDQ.nAxisQ << 22;//(s64)struFOC_CurrLoop.nQCur_Reference << 22;
...
#if (BRAKE_IQ_EN == TRUE)
		if((FRSControl.CrossDownAcState == 1)&&(struFOC_CtrProc.eSysState == RUN))//10500 12387 15000
		{
//          //Torque
//          if(struFOC_CurrLoop.mPI_Torque_BRAKE.KP > struFOC_CurrLoop.mPI_Torque.KP)
//					{
//					   struFOC_CurrLoop.mPI_Torque.KP += 3;
//					}
//					else if(struFOC_CurrLoop.mPI_Torque_BRAKE.KP < struFOC_CurrLoop.mPI_Torque.KP)
//					{
//						 struFOC_CurrLoop.mPI_Torque.KP --;
//					}
//					
//          if(struFOC_CurrLoop.mPI_Torque_BRAKE.KI > struFOC_CurrLoop.mPI_Torque.KI)
//					{
//					   struFOC_CurrLoop.mPI_Torque.KI += 3;
//					}
//					else if(struFOC_CurrLoop.mPI_Torque_BRAKE.KI < struFOC_CurrLoop.mPI_Torque.KI)
//					{
//						 struFOC_CurrLoop.mPI_Torque.KI --;
//					}
//					
//					//Flux
//          if(struFOC_CurrLoop.mPI_Flux_BRAKE.KP > struFOC_CurrLoop.mPI_Flux.KP)
//					{
//					   struFOC_CurrLoop.mPI_Flux.KP += 3;
//					}
//					else if(struFOC_CurrLoop.mPI_Flux_BRAKE.KP < struFOC_CurrLoop.mPI_Flux.KP)
//					{
//						 struFOC_CurrLoop.mPI_Flux.KP --;
//					}
//					
//          if(struFOC_CurrLoop.mPI_Flux_BRAKE.KI > struFOC_CurrLoop.mPI_Flux.KI)
//					{
//					   struFOC_CurrLoop.mPI_Flux.KI += 3;
//					}
//					else if(struFOC_CurrLoop.mPI_Flux_BRAKE.KI < struFOC_CurrLoop.mPI_Flux.KI)
//					{
//						 struFOC_CurrLoop.mPI_Flux.KI --;
//					}
//(s32)struFluxOB_Param.nQ_CurrLoopKP*struFOC_CurrLoop.mPI_Torque_BRAKE.KP>>6;
		...
		else
		{
			 ...
			 u16 t_KpDH,t_KiDH,t_KpQH,t_KiQH;
			 t_KpQH = (s32)struFluxOB_Param.nQ_CurrLoopKP*P_CURRENT_KP_H>>10;
			 t_KiQH = (s32)struFluxOB_Param.nQ_CurrLoopKI*P_CURRENT_KI_H>>10;
			
			 t_KpDH = (s32)struFluxOB_Param.nD_CurrLoopKP*P_CURRENT_KP_H>>10;
			 t_KiDH = (s32)struFluxOB_Param.nD_CurrLoopKI*P_CURRENT_KI_H>>10;
			 ...
			 else if(ABS(struMotorSpeed.wSpeedEst) <= (6000+16384))
			 {
			 struFOC_CurrLoop.mPI_Torque.KP = struFluxOB_Param.nQ_CurrLoopKP + ((s32)(t_KpQH - struFluxOB_Param.nQ_CurrLoopKP)*(ABS(struMotorSpeed.wSpeedEst) - 6000)>>14);
			 struFOC_CurrLoop.mPI_Torque.KI = struFluxOB_Param.nQ_CurrLoopKI + ((s32)(t_KiQH - struFluxOB_Param.nQ_CurrLoopKI)*(ABS(struMotorSpeed.wSpeedEst) - 6000)>>14);
			
			 struFOC_CurrLoop.mPI_Flux.KP = struFluxOB_Param.nD_CurrLoopKP + ((s32)(t_KpDH - struFluxOB_Param.nD_CurrLoopKP)*(ABS(struMotorSpeed.wSpeedEst) - 6000)>>14);
			 struFOC_CurrLoop.mPI_Flux.KI = struFluxOB_Param.nD_CurrLoopKI + ((s32)(t_KiDH - struFluxOB_Param.nD_CurrLoopKI)*(ABS(struMotorSpeed.wSpeedEst) - 6000)>>14);
				 
				 
			 }
			 //else if(ABS(struMotorSpeed.wSpeedEst) >= (6000+8192))
			 else
			 {
			 ...
			 struFOC_CurrLoop.mPI_Flux.KI = (s32)struFluxOB_Param.nD_CurrLoopKI*P_CURRENT_KI_H>>10;
			 }
...
//			 if(struMotorSpeed.wSpeedEst >15000)
//			 {  //Torque
//          if(struFOC_CurrLoop.mPI_Torque_H.KP > struFOC_CurrLoop.mPI_Torque.KP)
//					{
//					   struFOC_CurrLoop.mPI_Torque.KP += 3;
//					}
//					else if(struFOC_CurrLoop.mPI_Torque_H.KP < struFOC_CurrLoop.mPI_Torque.KP)
//					{
//						 struFOC_CurrLoop.mPI_Torque.KP --;
//					}
//					
//          if(struFOC_CurrLoop.mPI_Torque_H.KI > struFOC_CurrLoop.mPI_Torque.KI)
//					{
//					   struFOC_CurrLoop.mPI_Torque.KI += 3;
//					}
//					else if(struFOC_CurrLoop.mPI_Torque_H.KI < struFOC_CurrLoop.mPI_Torque.KI)
//					{
//						 struFOC_CurrLoop.mPI_Torque.KI --;
//					}
//					
//					//Flux
//          if(struFOC_CurrLoop.mPI_Flux_H.KP > struFOC_CurrLoop.mPI_Flux.KP)
//					{
//					   struFOC_CurrLoop.mPI_Flux.KP += 3;
//					}
//					else if(struFOC_CurrLoop.mPI_Flux_H.KP < struFOC_CurrLoop.mPI_Flux.KP)
//					{
//						 struFOC_CurrLoop.mPI_Flux.KP --;
//					}
//					
//          if(struFOC_CurrLoop.mPI_Flux_H.KI > struFOC_CurrLoop.mPI_Flux.KI)
//					{
//					   struFOC_CurrLoop.mPI_Flux.KI += 3;
//					}
//					else if(struFOC_CurrLoop.mPI_Flux_H.KI < struFOC_CurrLoop.mPI_Flux.KI)
//					{
//						 struFOC_CurrLoop.mPI_Flux.KI --;
//					}
//			 }
...
//					   struFOC_CurrLoop.mPI_Torque.KP -= 3;
//					}
//					else if(struFOC_CurrLoop.mPI_Torque.KP < struFluxOB_Param.nQ_CurrLoopKP)
//					{
//						 struFOC_CurrLoop.mPI_Torque.KP ++;
//					}
//					
...
//					   struFOC_CurrLoop.mPI_Torque.KI -= 3;
//					}
//					else if(struFOC_CurrLoop.mPI_Torque.KI < struFluxOB_Param.nQ_CurrLoopKI)
//					{
//						 struFOC_CurrLoop.mPI_Torque.KI ++;
//					}
//					
//					//Flux
//          if(struFOC_CurrLoop.mPI_Flux.KP > struFluxOB_Param.nQ_CurrLoopKP)
//					{
//					   struFOC_CurrLoop.mPI_Flux.KP -= 3;
//					}
//					else if(struFOC_CurrLoop.mPI_Flux.KP < struFluxOB_Param.nQ_CurrLoopKP)
//					{
//						 struFOC_CurrLoop.mPI_Flux.KP ++;
//					}
//					
//          if(struFOC_CurrLoop.mPI_Flux.KI > struFluxOB_Param.nQ_CurrLoopKI)
//					{
//					   struFOC_CurrLoop.mPI_Flux.KI -= 3;
//					}
//					else if(struFOC_CurrLoop.mPI_Flux.KI < struFluxOB_Param.nQ_CurrLoopKI)
//					{
//						 struFOC_CurrLoop.mPI_Flux.KI ++;
//					}
//			 }
