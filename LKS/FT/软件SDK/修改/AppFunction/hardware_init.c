...
//	DAC_InitStructure.DACOUT_EN = ENABLE ;//使能DAC电压通过P0.0输出
	...
	//	DAC_OutputVoltage(3*BIT12);  /* DAC 输出1.0V */
	DAC_OutputVoltage(0.5*BIT12);  /* DAC 输出0.5V */
}
...
void ADC_init(void)
{
  ...
  ADC_InitStructure.FirSeg_Ch = 5;                        /* 第一段共采样6个通道 */
...
//    /*Timer0 P0.8-CH0,P0.9-CH1*/
//    GPIO_InitStruct.GPIO_Mode = GPIO_Mode_IN;
//    GPIO_InitStruct.GPIO_Pin =  GPIO_Pin_8 | GPIO_Pin_9;
//    GPIO_Init(GPIO0, &GPIO_InitStruct);
//    GPIO_PinAFConfig(GPIO0, GPIO_PinSource_8, AF7_TIMER0);
//    GPIO_PinAFConfig(GPIO0, GPIO_PinSource_9, AF7_TIMER0);
...
//    GPIO_ResetBits(GPIO1, GPIO_Pin_7);
		...
		/* P0.6 SW_TEMP  P0.8 ZERO_SCR P0.10 SPD_HIGH  */
//    GPIO_InitStruct.GPIO_Mode = GPIO_Mode_IN;
//    GPIO_InitStruct.GPIO_PuPd = GPIO_PuPd_NOPULL;
//    GPIO_InitStruct.GPIO_Pin =  GPIO_Pin_6|GPIO_Pin_8|GPIO_Pin_10;
//    GPIO_Init(GPIO0, &GPIO_InitStruct);
//    GPIO_InitStruct.GPIO_Mode = GPIO_Mode_IN;
//    GPIO_InitStruct.GPIO_PuPd = GPIO_PuPd_NOPULL;
...
void UTimer_init(void)
{
    ...
    TIM_TimerStrutInit(&TIM_InitStruct);
    TIM_InitStruct.EN = ENABLE;
    TIM_InitStruct.TH = 0xFFFF;
    TIM_InitStruct.CAP0_CLR_EN = ENABLE;
    TIM_InitStruct.SRC0 = TIM_SRC0_0;     /* 选择通道0*/
    TIM_InitStruct.CH0_MODE = 1;          /* 0为比较模式，1为捕获模式 */
    TIM_InitStruct.CH0_RE_CAP_EN = 1;     /*上升沿捕获使能*/
    
    TIM_InitStruct.SRC1 = TIM_SRC0_1;     /* 选择通道1*/
    TIM_InitStruct.CH1_MODE = 1;          /* 0为比较模式，1为捕获模式 */
    TIM_InitStruct.CH1_FE_CAP_EN = 1;     /*下降沿捕获使能*/
    
    TIM_InitStruct.IE = TIM_IRQ_IE_ZC | TIM_IRQ_IE_CH0;
...
void MCPWM_init(void)
{
  ...
  MCPWM_InitStructure.TriggerPoint0 = (u16)(PWM_PERIOD - 20);//100 /* MCPWM_TMR0 ADC触发事件T0 设置 */
  ...
  MCPWM_InitStructure.FAIL1_INT_EN = DISABLE;               /* FAIL0事件 中断使能或关闭 */
