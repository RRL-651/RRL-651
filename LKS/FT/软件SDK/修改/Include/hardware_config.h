...
#define ADC_BUS_VOL_CHANNEL            (ADC_CHANNEL_2)      /* 母线电压ADC采样通道 */
#define AC_ZERO_CHEAK_CHANNEL            (ADC_CHANNEL_4)      /* AC电压ADC采样通道 */

#define NTC_CHEAK_CHANNEL            (ADC_CHANNEL_5)      /* NTC电压ADC采样通道 */
#define M0_ADC_BUS_CURR_CH             (ADC_CHANNEL_OPA1)      /* 母线电流ADC采样通道 */

#define ADC_TEMP_CHANNEL              (ADC_CHANNEL_1)      /* 温度检测 */
//#define ADC_TEMP_CHANNEL              (ADC_CHANNEL_3)      /* 温度检测 */
...
#define GET_AC_ZERO_CHEAK_CHANNEL      (ADC_DAT3)      
#define GET_NTC_CHEAK_CHANNEL     		 (ADC_DAT4)  
